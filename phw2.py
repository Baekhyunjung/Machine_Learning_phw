...
params.append({'n_components': [3,5,7,10],
               'covariance_type': ['full', 'tied'], 'tol': [1e-2, 1e-3, 1e-4]})

models.append('clarans') # CLARANS
params.append({'number_clusters': [3,5,7,10],
               'numlocal': [1,3,5], 'maxneighbor': [3,4]})
...
params.append({'damping': [0.8, 0.9, 1.0]})
